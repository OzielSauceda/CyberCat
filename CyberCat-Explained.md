...
- **Phase 19.5:** Chaos testing — live verification of `chaos-redis.yml` on a Linux runner + any follow-up resilience work it surfaces. The workflow is in the repo at `.github/workflows/chaos-redis.yml`; the regression gate is ready.
