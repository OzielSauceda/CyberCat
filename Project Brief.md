...
Wazuh:  
Wazuh should be the primary security telemetry source and event feeder in the initial architecture. It should provide the upstream security visibility that the custom platform consumes. The system should integrate with Wazuh seriously rather than treating it like a side tool. Wazuh should be understood as the upstream event source, not the star of the project.
